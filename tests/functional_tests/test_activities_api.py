...
BASE_URL = "http://127.0.0.1:8000"  # Using IP instead of localhost for better performance
...
def test_list_activities(http_session, user_id, test_activity_data):
    ...
    # Generate new name for second activity
    activity2_name = f"test_adder_{uuid.uuid4().hex[:8]}"
    activity2["activity_name"] = activity2_name
    activity2["params"]["activity_name"] = activity2_name
